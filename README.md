...
|    10   |                                                                                                       |                                                                                                                                                                                                      |               |  Apr 14 |           |
|    11   |                                       Development: registration                                       |                           Create a registration systmem that allows user to creat an acoount that gets saved in the databse, the password must get hashed when being saved.                          |     40 min    |  Apr 15 |     C     |
|    12   |                                           Development: login                                          |                            Create a login system that reads and compares information inputed in the login form and makes sure that it matches with a user in the database                            |      1 hr     |  Apr 16 |     C     |
|    13   |                                 Development: Wireframe and ER diagram                                 |    Create a diagram of what the project will have and how things will be connected. Then a second diagram that illustrates the relationships between different database elements in th eproject.     |     30 min    |  Apr 17 |     C     |
|    14   |                                                                                                       |                                                                                                                                                                                                      |               |  Apr 18 |     C     |
|    15   |                                    Development: image upload method                                   |                                                        Using a file input make a user input for a file that saves the file into the database                                                         |     15 min    |  Apr 19 |     C     |
|    16   |                                   Development: image upload button                                    |                                                                Make a button that make clear the file upload as an input from the user                                                               |      1 hr     |  Apr 19 |     C     |
|    17   |                           Development: updating and creating html templates                           |                                         Develop all corresponding html's for the routes inn the code, for exammple the home rousoute is still missing an html                                        |      1 hr     |  Apr 19 |     C     |
|    18   |                                    Design: creating a testing plan                                    |                                         The databse is not saving the file input as planned, brainstorm a different approach for this seciton of the website                                         |     20 min    |  Apr 19 |     C     |
|    19   |                                  Development: solving database issues                                 |                                         The databse is not saving the file input as planned, brainstorm a different approach for this seciton of the website                                         |     50 min    |  Apr 19 |     C     |
|         |                                Development: posting  function and html                                |                                                               Create a posting function that allows the user to create and uplad posts                                                               |     35 min    |  Apr 19 |     C     |
|    20   |                       Development: unit testing for login and registrationsystem                      |                                                                                    First unit testing by developer                                                                                   |     10 min    |  Apr 19 |     C     |
|    21   |                               Development: unit testing for posting page                              |                                                                                     Unit testing for the posting                                                                                     |     10 min    |  Apr 19 |     C     |
|    22   |                               Development: unit testing for image upload                              |                                                                                Unit testing of the image uplad method                                                                                |     10 min    |  Apr 20 |     C     |
|    23   |                           Development: identify issues with the image upload                          |                                                      After the testing several issues with the fucntionality of th etesting have been identified                                                     |     30 min    |  Apr 20 |     C     |
|    24   |                               Development: solve issues of image upload                               |                      Revise why the the image isnot being saved into the statics forlder and find a solution by either fixing the issue or finding a better way to upload images                     |      1 hr     |  Apr 20 |     C     |
|    25   |                           Development: second unit testing for image upload                           |                                   After chagning the image upload method have a unit testing to see if the issue has been resolved with the new link upload method                                   |     10 min    |  Apr 20 |     C     |
|    26   |                                  Planning: reviewing success criteria                                 |                                    According to how the develpment of  the program is going, review the success criteria, their complishon and any changes needed                                    |     15 min    |  Apr 21 |     B     |
|    27   |                                  Planning: improving success criteria                                 |                 If changes are required in the succes criteria, create a seprate file where to make the changes before commiting them to the repository without consulting the client                |     20 min    |  Apr 22 |     B     |
|    28   |                       Planning: consult client about changes in succes criteria                       |                                                Contact client to inform about necessarry changes on the succes criteria, get their input and approval                                                |     15 min    |  Apr 25 |     B     |
|    29   |              Development: change image upload to use file name to work with the database              |                                             Changed the type of input to an image link and edited the html to use the links as sources inside a for loop                                             |  1 hr 30 min  |  Apr 25 |     C     |
|    30   |                               Development: individual user profile pages                              |                                          Make the html pages be individual to each user, intead of them working as a general page with posts from all users                                          |      2 hr     |  Apr 27 |     C     |
|    31   |                    Development: Evaluate functionality and make changes to my code                    |                                                                     Change image upload form field to text input insteasd of file                                                                    |     7 min     |  Apr 27 |     C     |
|    32   | Development: Make it so that people can look at other users profiles, without being able to add posts |                        Create an outsider_profile_view that retrieves the post information form the database and creates a text form with for inputing and uploading comments                        |     2 hrs     |  Apr 27 |     C     |
|    33   |                                     Development: comment creation                                     |                                                                        Designing a form for users to input and upload comments                                                                       |      1 hr     |  Apr 29 |     C     |
|    34   |                                    Development: Menu page creation                                    |                                               Creating a menu page app.route and its corresponding html. Also have a biger emphaciz on its css design.                                               |     40 min    |  May 1  |     C     |
|    35   |                                    Development: home page creation                                    |                                                                                Designing and implementing a home page                                                                                |     20 min    |  May 1  |     C     |
|    37   |                                   Development: CSS design and update                                  |                                                                           Updating and styling the CSS for improved design                                                                           |      1 hr     |  May 1  |     C     |
|    38   |                                   Development: buttons functionality                                  |                                                                Ceating buttons to navigate the site and making sure they work properly                                                               |      1 hr     |  May 2  |     C     |
|    39   |                                Development: Non-developer user testing                                |                                                                             Testing the product with non-developer users                                                                             |     15 min    |  May 2  |     C     |
|    40   |                                      Developmetn: Client testing                                      |                                                                                  Testing the product with the client                                                                                 |     15 min    |  May 4  |     C     |
|    41   |                                    Development: code documentation                                    |         Documenting the code on criteria C  for better understanding and maintainability. This includes explaining how parts of the code work and documenting challenges and solutions faced.        |     3 hrs     | May 5-7 |     C     |
|    42   |                                 Evaluation: Client product evaluation                                 |                                                                Client evaluating the product based on client requirements and feedback                                                               |     15 min    |  May 9  |     E     |
|    43   |                              Evaluation: External user product evaluation                             |                                                            External user evaluation the product based on client requirements and feedback                                                            |     15 min    |  May 9  |     E     |
|    44   |                                     Functionality: Video recording                                    |                                                                             Record video on functionality of the program                                                                             |     20 min    |  May 10 |     D     |
### ER Diagram
